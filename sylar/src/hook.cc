...
unsigned int sleep(unsigned int seconds) {
    ...
    sylar::IOManager* iom = sylar::IOManager::GetThis();    //有bug
        ...
        case F_SETFL:
            {
                ...
                ctx->setUserNonblock(arg & O_NONBLOCK); //用户设置的非阻塞 记到fdctx里
